...
function Map() { // const [location, setLocation] = useState("Lobby");
        ...
        <div>
            ...
            <div className="img-container">
                <img id="bev-map"
                    ...
                    alt="Tembusu Lobby"
                    className="map-background"/> {/* inner text of <object> is alt text */}
                <object id="bev-svg" className="map-overlay" data="/assets/Lobby_clickable.svg" type="image/svg+xml">
                    placeholder image
                </object>
            </div>
            <div>
