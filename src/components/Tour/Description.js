export const roomNames = {
  ...
  "start-image": "Explore Tembusu College",
};

export const roomDescriptions = {
  mph: "A dynamic space, the Multi-Purpose Hall is utilised by many Tembusu College’s Interest Groups, from sports to performing arts. Be it Badminton, Rollerblading or Dance, the College is home to a wide array of IGs for you to discover fun activities you’d enjoy! This hall also serves as the place where we hosts our flagship event, the Tembusu Conversations.",
  lobby:
  ...
  "sem-room":
    "Seminar Rooms are a key feature of the Learn Lobe - they form the environment in which learning takes flight! One can look forward to both Junior Seminars (JS) and Senior Seminars (SS), as well as Ideas and Exposition Modules (IEMs), being held in these classrooms. Many Tembusians can vouch for the riveting courses they have attended under the University Town College Programme. \n \n In addition to the interesting topics that the courses at Tembusu College explore, Seminar Rooms offer an intimate learning environment where you’ll be able to have lively class discussions with your peers. Furthermore, if you’re looking for a conducive space to get some work done or to run student activities, our Seminar Rooms can be booked for such purposes as well!",
  "reading-room":
    "Curated by our Tembusu College Rector and Fellows, the Reading Room is home to a collection of books for students to discover and expand their reading repertoire. It is also the dynamic space where Tembusu College holds its Student’s Teas. ",
  abbey:
    "If you love music, you’re at the right place! The Abbey is Tembusu College’s very own music studio. Equipped with state-of-the-art sound systems and instruments, the stage is set for you and like-minded musicians to jam and have fun!",
  "box-office":
    "Whether you are a coffee lover, film buff, or simply looking for a space to chill, The Box Office has got you covered! Not only is it Tembusu College’s own home cinema, it is also a place where you can play games, relax  and bond over making coffee. ",
  oasis:
  ...
  "misty-garden":
    "A lovely garden located at Level 3, Misty Garden (named after the inaugural Tembusu College Master’s cat), represents the College’s commitment to biodiversity, the natural environment and sustainability. Tembusu College Urban Farmers is one student group reflective of such an ethos - and they’re the team that helps tend to this garden!",
