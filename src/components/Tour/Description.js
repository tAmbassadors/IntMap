...
export const roomDescriptions = {
  ...
  "sem-room":
    "Seminar Rooms are a key feature of the Learn Lobe - they form the environment in which learning takes flight! One can look forward to both Junior Seminars (JS) and Senior Seminars (SS) as well as Ideas and Exposition Modules (IEMs) being held in these classrooms. Many Tembusians can vouch for the riveting modules they have attended under the University Town College Programme. \n \n In addition to the interesting topics that the modules at Tembusu explore, Seminar Rooms offer an intimate learning environment where you’ll be able to have lively class discussions with your peers. Furthermore, if you’re looking for a conducive space to get some work done or to run student activities, our Seminar Rooms can be booked for such purposes as well!",
  "reading-room":
