...
function Svg(props) {
  ...
  const room = (
    <svg
      ...
      viewBox="0 0 6016 4016"
    >
      <a href="javascript:void(0);" onClick={() => changeLocation("suite")}></a>
      <polygon
  ...
  const learnlobeB1 = (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1780.5 1188.6">
  ...
  const learnlobeWalkway = (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1644.6 1098">
      <g id="Layer_7" data-name="Layer 7">
        <polygon
  ...
  const corridor = (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1762.2 1176.3">
      <g id="Layer_7" data-name="Layer 7">
        <polygon
  ...
  const lobby = (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2435.1 1623.3">
      <g id="Layer_7" data-name="Layer 7">
        <polygon
  ...
  const entrance = (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2476.8 1651.2">
      <g id="Layer_7" data-name="Layer 7">
        <polygon
        ...
        <polygon
          ...
          style="fill:#fff"
        />
        <a href="javascript:void(0);" onClick={() => changeLocation("mph")}></a>
        <polygon
  ...
  const suite = (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 5081.59 3392.23">
      <g id="Layer_7" data-name="Layer 7">
        <polygon
